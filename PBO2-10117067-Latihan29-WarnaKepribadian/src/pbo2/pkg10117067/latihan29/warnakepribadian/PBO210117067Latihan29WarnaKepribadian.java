 ...
 * MATAKULIAH : PBO2
 * NIM        : 10117067
 * DESKRIPSI PROGRES : Program ini dibuat untuk MENAMPILKAN WARNA KEPRIBADIAN
 */
package pbo2.pkg10117067.latihan29.warnakepribadian;
 ...
 * @author Ihsanmi
 */
public class PBO210117067Latihan29WarnaKepribadian {
    ...
    public static void main(String[] args) {
        ...
        if (Pilih.equalsIgnoreCase("MERAH")) {
            ...
            System.out.println("1. Menyenangkan, \n"
                    ...
                    + "9. Menyembunyikan perasaan karena karakternya yang cenderung mencari jalan damai. \n");
